...
const App = () => {
  ...
  const statest = useStateValue();
  console.log('state testi',statest[0].patients);
  console.log('state testi',statest[0].diagnoses);
  console.log('state testi',statest[0].entries);
