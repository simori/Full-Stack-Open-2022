...
const App = () => {
  ...
  useSubscription(BOOK_ADDED, {
    onSubscriptionData: ({ subscriptionData }) => {
      console.log('subskription dataa kun kirja lisättiin!', subscriptionData)
      const addedBook = subscriptionData.data.bookAdded
      console.log('frontend addedBook', addedBook)
      // 8.25
      ...
      /*Missing field 'born' while writing result {
        "name": "Miro Sihimäki",
        "__typename": "Author"
      }

      Missing field 'bookCount' while writing result {
        "name": "Miro Sihimäki",
        "__typename": "Author"
      }*/
      /* client.cache.updateQuery({ query: ALL_AUTHORS }, ({ allAuthors }) => {
        console.log('ALL_AUTHORS addedBook author', addedBook.author)
        return {
          allAuthors: allAuthors.concat(addedBook.author),
        }
      }) */
      // Missing field 'genres' while writing result "genre6"
