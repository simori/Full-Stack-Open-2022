...
const Books = (props) => {
  ...
  //console.log('haetaan GraphQL:llä kirjat. genre on', genre)
  const getBooks = useQuery(GET_BOOKS, { variables: { genre: genre } })
  //console.log('haetaan GraphQL:llä kirjat. getBooks kysely:', getBooks)
  console.log('getBooksin data:', getBooks.data)

  const getGenres = useQuery(GET_GENRES)
  console.log('getBGenresin data:', getGenres.data)
  ...
  console.log('kaikki uniquet genret: ', uniqueGenres)
